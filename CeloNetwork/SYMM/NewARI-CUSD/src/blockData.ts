...
import { uncappedTokens, tokenCaps, SYMM_TOKEN } from './tokens';
...
export async function processPoolData(poolDatas) {
    //////////////////////////////////////////////////////////////////
    ...
    let targetFinalLiquidity = totalBalancerLiquidity.div(
        bnum(1).minus(bnum(400).div(bnum(4153.8461))) // why div by 45000 / 145000
    );
    ...
    // console.log(`finalPoolsWithBalMultiplier: ${JSON.stringify(finalPoolsWithBalMultiplier)}`);
