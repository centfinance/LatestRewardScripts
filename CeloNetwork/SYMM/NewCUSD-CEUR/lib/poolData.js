...
var _require2 = require('../lib/subgraph'),
    fetchBalanceOf = _require2.fetchBalanceOf;

var _require3 = require('./factors'),
    getFeeFactor = _require3.getFeeFactor,
    getBalFactor = _require3.getBalFactor,
    getBalAndRatioFactor = _require3.getBalAndRatioFactor,
    getWrapFactor = _require3.getWrapFactor;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 21:
            ...
            console.log("ZERG 2"); // determine if the pool should be split up
            // based on pool and lp composition and get the balances of the providers in
            // the pool

            subpoolLiquidityProviders = splitLiquidityProviders(poolLiquidityProviders, poolTokens);
            console.log("ZERG 3"); // bpt held by each lp
          ...
          case 29:
            ...
            console.log("ZERG 4"); // total bpt held by nonshareholders, shareholders
            ...
            console.log("ZERG 6"); // calculate these values for both subpools if relevant
