...
exports.fetchBalanceOf = exports.fetchAllPools = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            query = "\n            {\n                pools (where: { id_in: [\"0x5fa00d2ba520f95f548ff0813f9f74facdf1b807\"]},\n                    first: 1000, skip: ".concat(skip, ", block: { number: ").concat(block, " } ) {\n                    id\n                    publicSwap\n                    swapFee\n                    controller\n                    createTime\n                    tokensList\n                    totalShares\n                    shares (first: 1000) {\n                        userAddress {\n                            id\n                        }\n                    }\n                }\n            }\n        ");
            _context.next = 7;
...
var fetchBalanceOf = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(web3Utils, block, lp, poolAddress) {
    var poolResults, query, response, _yield$response$json2, data, returnVal;
  ...
  return function fetchBalanceOf(_x3, _x4, _x5, _x6) {
