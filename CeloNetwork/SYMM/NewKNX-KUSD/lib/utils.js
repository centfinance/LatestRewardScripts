    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://symmetricrewardstorage.blob.core.windows.net/newcontainer/eligible-knx-kusd.json", {
              headers: {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            if (tokenAddress == 'kusd') {
              bSubstituted = true;
              tokenAddress = 'kusd-t';
            }

            if (tokenAddress == 'knoxedge') {
              bSubstituted = true;
              console.log("GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGg");
              tokenAddress = 'terra-luna';
            }
